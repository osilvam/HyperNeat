...
void node_gene::eval(double value)
{
	...
	if(this->is_ready())
	{
		...
		this->accumulative_result = 0;
		//========================================
		//cout << "node: " << node << " | type: " << type << " | gives: " << this->final_result << endl;
		//========================================
	}
}
...
void Genetic_Encoding::CJsonDeserialize(char pch[])
{
	int node;
	int type;
	int innovation;
